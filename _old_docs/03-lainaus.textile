---
title: 'Kohan ohje suomeksi - Lainaus'
permalink: /docs/lainaus/
...
h2. 2.1.1 Kuittien tulostaminen
...
h2. 2.1.2 Asiakastietojen tyhjennys näytöltä
...
h2. 2.2 Lainausviestit

h3. Huomautus liitteistä
...
h3. Aineisto on varattu jollekin toiselle asiakkaalle. Varausta ei ole vielä otettu kiinni.

!{width:70%}lainhuom1.PNG!

h3. Nide on varaushyllyssä varattuna toiselle asiakkaalle. 
...
h3. Nide on jo lainassa tällä asiakkaalla.

!lainhuom3.PNG!

h3. Aineisto on lainassa toisella asiakkaalla.

!lainhuom4.PNG!

h3. Aineistoa ei lainata (niteen tila on "Ei lainattavissa").

!lainhuom5.png!

h3. Asiakkaalla on liian monta lainaa.

!lainhuom6.png!

h3. Viivakoodia ei löytynyt.

!lainhuom7.png!

* Kohassa on mahdollista käyttää pikaluettelointia, jos se on sallittu järjestelmäasetuksissa.

h3. Lainattava nide on merkitty kadonneeksi.

!lainhuom8.png!

* Lainausasetusten määrittelystä riippuu, tuleeko huomautusta.

h3. Lainattavalla niteellä on ikärajoitus, ja asiakas on liian nuori.

!lainhuom9.png!

h3. Lainattavalla niteellä on paljon varauksia, jonka takia lyhennetään laina-aikaa.
...
h2. 2.5.1 Palautuksen viestit

h3. Toisen kirjaston aineisto
...
h3. Varaus toisessa kirjastossa
...
h3. Kadonneeksi merkityt niteet
...
h3. Varauksen teko tiedonhaun kautta
...
h3. Varauksen teko asiakastietojen kautta
...
h3. Varauksen kiinnittäminen viimeiseksi jonossa
...
h3. Yksittäisen varauksen keskeyttäminen
...
Kun varaus on keskeytetty, varauksen kohdalle tulee _Jatka_-nappi ja näkyy päivämäärä, mihin saakka keskeytys on voimassa. Voit palauttaa varauksen voimaan myös (tyhjentämällä päivämäärän ja) klikkaamalla Jatka.

!keskeytyksenjatk.png!

h3. Asiakkaan kaikkien varauksien keskeyttäminen
...
h3. Varauksen poistaminen

Varauksen poistaminen onnistuu yksitellen klikkaamalla varauksen kohdalla punaista ruksia. 

!varauksenpoisto1.png!

Varauksen voi myös poistaa asiakkaan tiedoissa _Varaukset_-välilehdellä valitsemalla Poista?-sarakkeeseen "Kyllä" ja klikkaamalla _Peruuta valitut varaukset_ -nappia.

!varauksenpoistoA.png!
...
h3. 2.9.2 Varaus palautetaan automaattiin 
...
h3. 2.9.3 Varausten näkyminen asiakkaan tiedoissa
...
# Kuljetettavana noutokirjastoon
# Odottaa noutopisteessä
...
h3. 2.9.4 Kiinni jääneiden varausten näkyminen kokoelmatiedoissa ja varausjonossa
...
# _Ylimmäisenä:_ automaatilla palautettu, kiinni jäänyt varaus, noutoilmoitusta ei vielä lähetetty. Priority-sarakkeessa varaus on In transit/Kuljetettavana-tilassa.
# _Keskimmäisenä:_ noudettavissa oleva, noutoilmoitus lähetetty. Priority-sarakkeessa tietona Waiting/Odottaa
# _Alimmaisen:_ Kuljetettavana oleva varaus.


---

h2. Varauksen noutaa muu kuin varaaja itse
...
h2. 2.10 Siirto-toiminto

Kirjastokimpassa voit siirtää niteitä toiseen kirjastoon käyttämällä *Siirto*-työkalua.
* Valitse: Lainaus ja palautus -> *Siirto*

!siirto1.png!
Valitse alasvetovalikosta kirjasto, johon olet siirtämässä aineistoa ja lue siirrettävän niteen viivakoodi _Syötä viivakoodi_ -kohtaan. Paina lopuksi *OK*.
...
Jos työskentelet useammassa kirjastossa, pääset valitsemaan kirjaston _Aseta kirjasto_ -napista. Valitse kirjasto alasvetovalikosta ja klikkaa OK.
...
h2. 2.12 Pikaluettelointi (ei käytössä)

"Koha Manual - Fast Add Cataloging":http://manual.koha-community.org/3.16/en/fastaddcat.html

---

h2. 2.13 Lainauksen raportit
...
*Huomioi:* Koha-Suomi on tehnyt oman versionsa hyllyvarauslistasta. Se on kuvattu "wikin Raportit-osiossa":https://tiketti.koha-suomi.fi/projects/koha-suomen-dokumentaatio/wiki/7_Raportit#722-Hyllyvaraukset
...
Voit rajata hakua _Tarkenna tuloksia_ -valikosta vasemmalla. Oletusarvona alkupäivämääränä on 365 vrk ennen kuluvaa päivää, mutta päivämäärän voi muuttaa ennen hakua.

!raportti5.png!

Voit suodattaa hakutuloksesta _Kirjastot_-sarakkeen alla olevasta valikosta oman kirjastosi aineistot esille. Jos valintaa ei ole tehty, näkyvillä on _Ei mitään_.
...
h3. Noudettavissa olevat varaukset

Tämä raportti näyttää kaikki kirjastossasi noutoa odottavat niteet.

!nouto1.png!

Niteet, joiden noutoaika on mennyt umpeen, näkyvät _Vanhentuneet varaukset_ -välilehdellä.

h3. Varauksia per nide

Tällä raportilla näet mm. varausten määrän yhtä nidettä kohti.

!pernide.png!

h3. Vastaanotettavat kuljetukset
...
h3. Myöhässä ja maksuja

!lainrap12.png!

---

h2. 2.14 Kirjaston sisäisen käytön seuranta

Ei vielä sisältöä.

---

h2. 2.15 Offline eli yhteydettömän tilan lainaus

Vaikka nettiyhteys ei toimisi, voit jatkaa lainaamista. Vaihtoehtoina on 
# *Offline lainausohjelma Windowsille* (KOC). Erillinen ohjelma yksittäisille lainauskoneille. Tätä voi käyttää, kun ei ole yhteyttä internetiin. *Tämä on suositeltava vaihtoehto*
# *Koha Offline Circulation Tool* (KOCT), joka on selaimen lisäosa. Tätä voi käyttää esimerksi yllättävien verkkoyhteyskatkoksien aikana.
# *Yhteydettömän tilan lainaus*, jota voi käyttää, kun tietää ennakkoon, ettei yhteyttä ole. Esimerkiksi kirjastoautossa. *Ei suositella käytettäväksi*

h3. 2.15.1. Offline lainausohjelma Windowsille (KOC)
...
Lainaaminen tehdään Issues-välilehdellä. Asiakkaan kirjastokortin numero luetaan _Borrower Cardnumber_ -kenttään (tai tehdään haku asiakastietoihin Search-laatikon kautta). Kun olet syöttänyt kirjastokortin numeron, klikkaa _Accept. Lainattavat teokset luetaan _Item Barcode_ -kenttään ja Asiakkaan lainat näkyvät _Previously Scanned Barcodes_ -ikkunassa. Eräpäivää ei voi tässä määritellä, mutta se määrittyy automaattisesti aineistolle, kun lainaukset siirretään pääjärjestelmään. Asiakkaalle voi antaa aineistolajin mukaisen eräpäivälapun (kuittia ei pysty tulostamaan).

!Offline_12.PNG!


Kun asiakkaalle on lainattu kaikki aineisto, klikkaa _OK_ sivun alareunassa. Päivän ensimmäisen lainaajan jälkeen saat ikkunan, jossa valitset, millä nimellä ja mihin kansioon haluat tallentaa offline-tiedostot. Kaikki loput asiakkaat ja lainat tallentuvat samaan tiedostoon tai tiedostopaikkaan automaattisesti. Kannattaa käyttää aina samaa kaavaa, sillä tiedosto pitää osata myös hakea kansiosta, kun tiedot siirretään pääjärjestelmään. Esimerkissä on käytetty työpöytää tallennuspaikkana ja oletustiedostonnimeä (koostuu päivämäärästä ja kellonajasta: vvvv-kk-pp tunti-minuutti-sekunti-sekunninsadasosa).

!Offline_13.PNG!


_Returns_-välilehdellä voi tehdä palautuksia, mutta se ei ole suositeltavaa varausten takia.

!Offline_14.PNG!

_History_-välilehdellä näkyy kuluvan päivän lainaus- ja palautustapahtumat.
...
Mene _Lainaus ja palautus_ -näyttöön ja valitse sieltä _Lähetä yhteydettömän tilan lainaustiedosto (*.koc)_.
...
Esimerkissä tiedosto tallennettiin työpöydälle. Kun olet valinnut tiedoston, klikkaa _Avaa_-nappia ikkunan oikeassa alareunassa.
...
Kun kaikki tiedostot on lähetetty, klikkaa _Näytä käsittelyä odottavat yhteydettömän tilan tapahtumat_.

!Offline_21.png!

Seuraavalla näytöllä valitset kaikki rivit (jos siellä ei ole mitään virheilmoituksia, ne rivit voit jättää vaikka valitsematta jos sellaisia on) ja klikkaa _Käsittele_.
...
h3. 2.15.2 Koha Offline Circulation Tool (KOCT)
...
Lainausnäkymä:
!KOCTLainausnäkymä.PNG!



h3. 2.15.3 Yhteydettömän tilan lainaus

*Tämä ei ole suositeltava tapa*

h4. Etukäteen tehtävät toimet
...
Tämä antaa sinun ladata paikallisen kopion asiakkaista ja lainaustiedoista. Klikkaa _Lataa tietueet_ sivun vasemmassa yläreunassa. Kun tiedot on ladattu, näet niiden viimeisimmän päivitysajankohdan.
...
Kun verkkoyhteys ei ole käytettävissä, mene Yhteydettömän tilan lainaukseen Kohassa ja klikkaa _Lainaus_.
...
h4. Kohan yhteydettömän tilan tietojen lataaminen

Kun nettiyhteys on taas käytettävissä, synkronoi yhteydettömän tilan lainaukset (ja palautukset) klikkaamalla _Lähetystapahtumat_ (nuoli ylöspäin) klikkaamalla _Odottavat yhteydettömän tilan toimet_. Linkin yläpuolella voi lukea myös ettei ole odottavia tapahtumia, varmista kuitenkin asia Odottavan yhteydettömän tilan toimet linkistä.
...
* Klikkaa _Käsittele_-nappia ja Koha tallentaa jokaisen toiminnon yksitellen. Jokaiselle toiminnolle (issue = lainaus, return = palautus) on oma rivinsä ja ilmoitus onnistuuko toiminnon tallentaminen Kohaan.
